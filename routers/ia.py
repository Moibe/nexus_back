...
@router.post(
    ...
    description=(
        ...
        "A nivel raíz vienen DOS resúmenes de la calidad: `confianza_promedio`, "
        "el promedio de la confianza de todos los campos, que es el que la "
        "interfaz muestra como \"Nivel de confianza obtenida\"; y `confianza_minima`, "
        "la del peor campo, que delata un dato concreto mal leído cuando el resto "
        "salió bien. `_metadata.procesado_en` "
...
@router.post(
    ...
    description=(
        ...
        "(`confianza_promedio`, `confianza_minima`, `ocr`, `_metadata` y un campo por dato "
